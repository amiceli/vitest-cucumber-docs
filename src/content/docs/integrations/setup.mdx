...
**Since `7.0.0`** the plugin is exported from `@amiceli/vitest-cucumber/plugin`, not from the main entry point anymore.
...
**Note**: `specFilesDir` and `featureFilesDir` are folder paths, not glob patterns.
