...
<Aside type="tip">
This definition maps to the [`ScenarioType`](/integrations/utilities#scenariotype) type. Use [`serializeFeature`](/integrations/utilities#serialization) to parse and serialize feature files.
</Aside>
