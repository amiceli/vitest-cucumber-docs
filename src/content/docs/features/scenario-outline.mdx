...
<Aside type="tip">
This definition maps to the [`ScenarioOutlineType`](/integrations/utilities#scenariooutlinetype) type. Use [`loadFeatureFromText`](/integrations/utilities#parsing) to parse a feature file and [`serializeFeature`](/integrations/utilities#serialization) to convert it to a plain object.
</Aside>
