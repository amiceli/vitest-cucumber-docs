...
<Aside type="tip">
This definition maps to the [`ScenarioOutlineType`](/integrations/utilities#scenariooutlinetype) type. Use [`serializeFeature`](/integrations/utilities#serialization) to parse and serialize feature files.
</Aside>
