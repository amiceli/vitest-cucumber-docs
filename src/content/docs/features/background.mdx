...
<Aside type="tip">
This definition maps to the [`BackgroundType`](/integrations/utilities#backgroundtype) type. Use [`serializeFeature`](/integrations/utilities#serialization) to parse and serialize feature files.
</Aside>
